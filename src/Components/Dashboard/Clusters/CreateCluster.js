...
import { Dialog, DialogTitle, DialogContent, TextField, DialogActions, Button, MenuItem, Grid } from '@material-ui/core';
...
export function CreateCluster (props) {
	...
	return (
		<Dialog open={props.clusterCreateWindow} onClose={handleClusterCreateWindowClose} aria-labelledby="form-dialog-title">
			...
			<DialogActions>
				<Button onClick={handleClusterCreateWindowClose} color="primary">
					Cancel
				</Button>
